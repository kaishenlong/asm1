                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                        <form action="{{route('/danhmuc/'.$danhmuc['id'].'/updatedm')}}" method="POST">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="tenloai" placeholder="Tên Hàng Hóa" value="<?=$danhmuc['name']?>">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds"><input type="hidden" name="id" value="<?=$danhmuc['id']?>">
